...
import { Text, View, StyleSheet, SafeAreaView, Platform, StatusBar, Image, ScrollView, TextInput, Dimensions, Switch } from 'react-native';
                ...
                <View style={this.state.light_theme?styles.containerLight :styles.container}>
                    ...
                    <View style={styles.appTitle}>
                        ...
                        <View style={styles.appTitleTextContainer}>
                            <Text style={this.state.light_theme?styles.appTitleTextLight :styles.appTitleText}>Profile</Text>
                        </View>
                    </View>
                    <View style={styles.screenContainer}>
                        ...
                        <View style={styles.themeContainer}>
                            ...
                            <Switch
                                ...
                                trackColor={{ false: "#767577", true: this.state.light_theme?"#000":"#fff"}}
